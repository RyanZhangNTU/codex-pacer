...
The documentation set for installation, packaging, and release notes is being refreshed for the public `v1.0.0` release. Start with:

- [Getting started](./docs/en/getting-started.md)
- [Installing on macOS](./docs/en/installing-on-macos.md)
- [Packaging and release](./docs/en/packaging-and-release.md)
- [Release notes for v1.0.0](./docs/en/release-notes-v1.0.0.md)
